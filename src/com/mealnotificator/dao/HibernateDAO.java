 ...
 */
package com.mealnotificator.dao;

import com.mealnotificator.util.HibernateUtil;
 ...
 * @author George
 */
public class HibernateDAO<T, ID extends Serializable> implements Serializable {
